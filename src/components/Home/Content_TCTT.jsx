...
const Content_TCTT = (props) => {
  const { dataPost } = props;
  console.log("this is c", dataPost);
  return (
    <>
      <div
                ...
                <div class="cleft">
                  <h2>
                    <a href="" title="Thiết Kế 3D">
                      <span class="page-heading-title">Thiết kế nội thất</span>
                    </a>
                  </h2>
                  <p class="h2">
                    Thiết kế nội thất chuyên nghiệp. Phong cách đa dạng: cổ điển
                    - hiện đại, Bắc Âu, Wabi Sabi, ...
                  </p>
                </div>
                <div class="clear"></div>
              </div>
